...
DataDir = ['/projects/kg98/Thapa/DiCER/1_ParametersProject/3_DiCERParamsTests/1_CompareWhenToDenoise/3_DBScan_Output/'];
...
for i = 1:length(subID)
    ...
    for k = 1:170; % k is the number of signal/eigenvalues (assuming that you have 170 signal points) 
        ...
        IDScore(k) = (mean(diag(r))-mean(r(idx)))*100; %above line is the difference between the mean of diagonal and the mean of off-diagonalelements;you also can try median instead of mean
    end
