...
Table = table(ID, guessRate(:,1), precision(:,1), wmCapacity(:,1), guessRate(:,2), precision(:,2), wmCapacity(:,2));
Table.Properties.VariableNames = {'ID', 'GuessRate_Load2', 'Precision_Load2', 'wmCapacity_Load2', 'GuessRate_Load4', 'Precision_Load4', 'wmCapacity_Load4'};
