...
SUBJECT_LIST="/home/ttha0011/kg98/Thapa/MBBP/All_Subs/4_fMRIPrep/2_PE/SubjectIDs.txt"

# '#' SLURM_ARRAY_TASK_ID when running multiple subs
...
# paths
workdir=/projects/kg98/Thapa/MBBP/All_Subs/4_fMRIPrep/2_PE/Temp/${subject} # this directory is just a temp directory where intermediate outputs/files from fmriprep are dumped. It must be subject specific though!
bidsdir=/home/ttha0011/kg98/Thapa/MBBP/All_Subs/4_fMRIPrep/2_PE/rawdata # path to a valid BIDS dataset
derivsdir=/home/ttha0011/kg98/Thapa/MBBP/All_Subs/4_fMRIPrep/2_PE/derivatives # path to whether derivatives will go. This can be anywhere
